...
class CreditCard extends PayPalResourceModel
{
    ...
    public static function all($params, $apiContext = null, $restCall = null)
    {
        ...
        $payLoad = "";
        $allowedParams = ['page_size' => 1, 'page' => 1, 'start_time' => 1, 'end_time' => 1, 'sort_order' => 1, 'sort_by' => 1, 'merchant_id' => 1, 'external_card_id' => 1, 'external_customer_id' => 1, 'total_required' => 1];
        $json = self::executeCall(
